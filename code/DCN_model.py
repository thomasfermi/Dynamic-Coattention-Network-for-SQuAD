...
class DCN_qa_model(object):
    ...
    def train_old(self):
        ...
        for index_epoch in range(epochs):
            ...
            plt.savefig("figs_DCN/global_losses_epoch={}.png".format(index_epoch))
            plt.close()
            plt.plot(global_EMs)
            plt.savefig("figs_DCN/global_EMs_epoch={}.png".format(index_epoch))
            plt.close()
            plt.plot(global_f1s)
            plt.savefig("figs_DCN/global_f1s_epoch={}.png".format(index_epoch))
            plt.close()
            plt.plot(global_grad_norms)
            plt.savefig("figs_DCN/global_grad_norms_epoch={}.png".format(index_epoch))
    ...
    def plot_metrics(self, epoch_axis, global_losses, global_EMs, global_f1s, global_grad_norms):
        ...
        plt.xlabel("epoch")
        plt.ylabel("loss")
        plt.savefig("figs_DCN/training_losses_over_time.png")
        plt.close()

        plt.plot(epoch_axis, global_EMs)
        plt.xlabel("epoch")
        plt.ylabel("EM")
        plt.savefig("figs_DCN/training_EMs_over_time.png")
        plt.close()

        plt.plot(epoch_axis, global_f1s)
        plt.xlabel("epoch")
        plt.ylabel("F1")
        plt.savefig("figs_DCN/training_f1s_over_time.png")
        plt.close()

        plt.plot(epoch_axis, global_grad_norms)
        plt.xlabel("epoch")
        plt.ylabel("gradient_norm")
        plt.savefig("figs_DCN/training_grad_norms_over_time.png")
        plt.close()
    ...
    def train(self):
        ...
        plt.xlabel("epoch")
        plt.ylabel("EM_val")
        plt.savefig("figs_DCN/EM_val_over_time.png")
        plt.close()

        plt.plot(F1s_val)
        plt.xlabel("epoch")
        plt.ylabel("F1_val")
        plt.savefig("figs_DCN/F1_val_over_time.png")
        plt.close()
